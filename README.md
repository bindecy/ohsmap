...
Interestingly, this bug has been already [fixed](https://chromium.googlesource.com/chromium/src/+/0240b781039c83aa458e6ff72f2c0db9a18092eb%5E%21/content/browser/indexed_db/indexed_db_database.cc) two months ago, but only with the release of Version 78 in the last few days users are protected against the exploitation of this bug. Two months is quite a long gap and gives attackers a window of opportunity to exploit this bug in the meantime.
